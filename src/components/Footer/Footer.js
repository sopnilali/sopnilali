...
const Footer = () => {
  ...
  <Link href={'mailto: mdabduladud8@gmail.com'} className='text-2xl'><IoIosMail /></Link>
    ...
    <Link href={'https://github.com/sopnilali'} className='text-2xl'><FaGithub/></Link>
    <Link href={'https://www.linkedin.com/in/amiabduladud/'} className='text-2xl'><FaLinkedin/></Link>
